...
import { ClipboardList, Download, Calendar, TrendingUp, DollarSign, Users } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Generate and download various hospital reports</p>
        </div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {[
          { label: 'Total Reports', value: '1,234', icon: ClipboardList, color: 'blue' },
          { label: 'This Month', value: '156', icon: Calendar, color: 'green' },
          { label: 'Downloaded', value: '892', icon: Download, color: 'purple' },
          { label: 'Scheduled', value: '24', icon: TrendingUp, color: 'orange' },
        ].map((stat, index) => (
      ...
      <div className="bg-white/60 backdrop-blur-md rounded-xl shadow-soft p-6 border border-gray-100">
        ...
        <div className="space-y-3">
          {[
            { name: 'Daily Revenue Report', date: '2024-10-28', size: '2.4 MB' },
            { name: 'Patient Admission Report', date: '2024-10-28', size: '1.8 MB' },
            { name: 'Staff Attendance Report', date: '2024-10-27', size: '890 KB' },
            { name: 'Department Performance', date: '2024-10-27', size: '3.2 MB' },
          ].map((report, index) => (
