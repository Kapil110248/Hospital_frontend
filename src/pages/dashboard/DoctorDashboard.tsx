...
import { Calendar, FileText, FlaskConical, Activity, Clock, Users, CheckCircle, Plus, Search } from 'lucide-react';
...
export function DoctorDashboard() {
  ...
  const handleUpdateRadiologyStatus = async (id: string, status: string) => {
    try {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-display font-bold text-gray-900">Doctor Dashboard</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          <div className="bg-white/60 backdrop-blur-md rounded-xl shadow-soft p-6 border border-gray-100">
            <h2 className="text-xl font-bold text-gray-900 mb-4">Today's Appointment Queue</h2>
            {loading ? (
          ...
          <div className="bg-white/60 backdrop-blur-md rounded-xl shadow-soft p-6 border border-gray-100">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
                ...
                <span className="font-bold text-yellow-600">{stats.waiting + stats.inProgress}</span>
              </div>
            </div>
          </div>
        </div>
