import { Calendar, FileText, Pill, DollarSign, User, Download } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-display font-bold text-gray-900">Patient Portal</h1>
          <p className="text-gray-600 mt-1">Welcome back, John Doe</p>
        </div>
        <div className="flex gap-3">
          <Button variant="outline" icon={Download}>Download Records</Button>
          <Button variant="primary" icon={Calendar}>Book Appointment</Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white/60 backdrop-blur-md rounded-xl shadow-soft p-6 border border-gray-100">
            ...
            <div className="space-y-3">
              {[
                { doctor: 'Dr. Smith', specialty: 'Cardiology', date: 'Dec 20, 2024', time: '10:00 AM' },
                { doctor: 'Dr. Johnson', specialty: 'General Medicine', date: 'Dec 22, 2024', time: '2:30 PM' },
              ].map((apt, i) => (
                <div key={i} className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <span className="px-3 py-1 bg-blue-200 text-blue-800 rounded-full text-xs font-medium">Confirmed</span>
                  </div>
        ...
        <div className="space-y-6">
          <div className="bg-white/60 backdrop-blur-md rounded-xl shadow-soft p-6 border border-gray-100">
            <h2 className="text-xl font-bold text-gray-900 mb-4">Patient Profile</h2>
            <div className="space-y-3">
              ...
              <Button variant="outline" className="w-full mt-4" icon={User}>Edit Profile</Button>
            </div>
          </div>
            ...
            <div className="space-y-2">
              {[
                ...
                <div key={i} className="p-3 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Valid until: {rx.expires}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white/60 backdrop-blur-md rounded-xl shadow-soft p-6 border border-gray-100">
            <h2 className="text-xl font-bold text-gray-900 mb-4">Recent Lab Reports</h2>
            <div className="space-y-2">
              {[
                ...
                <div key={i} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  ...
                  <Button size="sm" variant="outline" icon={Download}>View</Button>
                </div>
              ))}
            </div>
          </div>
