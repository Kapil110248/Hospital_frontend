...
import { Pill, Package, AlertCircle, CheckCircle } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-display font-bold text-gray-900">Pharmacist Dashboard</h1>
            ...
            {loading ? (
              ...
              <DataTable
                ...
                columns={[
                  ...
                  {
                    header: 'Doctor',
                    accessor: (row) => row.doctor ? `Dr. ${row.doctor.first_name} ${row.doctor.last_name}` : 'N/A'
                  },
                  {
                    header: 'Date',
