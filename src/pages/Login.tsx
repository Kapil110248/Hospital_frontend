    ...
    <div className="min-h-screen bg-gradient-to-br from-hospital-purple/20 via-white to-teal-500/20 flex items-center justify-center p-4">
      <div className="bg-white/60 backdrop-blur-md rounded-2xl shadow-glass p-8 w-full max-w-4xl border border-gray-100">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-display font-bold text-gray-900">Hospital Management System</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            <h3 className="text-lg font-bold text-gray-900 mb-4">Quick Login - Demo Accounts</h3>
            <div className="space-y-2 max-h-96 overflow-y-auto">
              {[
                ...
                >
                  ...
                  <div className="text-xs opacity-75 mt-1">Password: {account.password}</div>
                </button>
              ))}
            </div>
          </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-600">
          ...
          <p className="mt-1">Click any role card to auto-fill credentials, then click Sign In</p>
        </div>
      </div>
    </div>
  );
